        ...
        if ($rs) { 
           ...
           echo"<table border='0' width='100%' >
                ...
                <tr>
                    ...
                    <td align='center' width='80%'><h1>REPORTE DE CLIENTES CON HORARIOS RESERVADOS</h1></td>
                    </tr>
                   </table>";
            ...
            <tr>
                <th>Nro</th><th>CLIENTE</th><th>HORA DE ATENCION</th>
            </tr>";
            $b=1;
            ...
            echo"<tr>
                    ...
                    <td>".$fila[ 'CLIENTE' ]."</td>
                    <td><i>".$fila[ 'HORA DE ATENCION']."</i></td>
                </tr>";
            $b=$b+1;
        }  
